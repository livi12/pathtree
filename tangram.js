...
baidu.dom.getPosition = function(a) {
    ...
    if (a.getBoundingClientRect) {
        ...
        do {
            ...
            l = l.offsetParent
        } while (l && l != a);if (d.opera > 0 || (d.isWebkit > 0 && h(a, "position") == "absolute")) {
...
(function() {
    ...
    function b() {
        ...
        var s = i + u.x - h;
        var t = q + u.y - f;
        if (u.x > 0 && u.x < Math.max(document.documentElement.clientWidth, window.innerWidth || 0) && u.y > 0 && u.y < Math.max(document.documentElement.clientHeight, window.innerHeight || 0)) {
            n.style.top = t + "px";
            n.style.left = s + "px"
        }
        if ((a !== s || p !== t) && (a !== null || p !== null)) {
            if (g(m.ondrag)) {
                m.ondrag(n, m)
            }
        }
...
baidu.dom.insertIntoTable = function(v, i, b, j) {
    var u = null, k = /^(?:br|frame|hr|img|input|link|meta|range|spacer|wbr|area|param|col)$/i, n = /^table|tbody|tr|td$/i, s, o = "afterbegin", p = "afterend", d = "beforebegin", q = "beforeend", a = "<table>", g = "</table>", c = a + "<tbody>", h = "</tbody>" + g, m = c + "<tr>", t = "</tr>" + h;
...
(function() {
    ...
    var d = function(C, x, F, G) {
        ...
        } while (z);if (D.length > 1 && j.exec(C)) {
...
baidu.data.XPC = baidu.lang.createClass(function(c, a, k) {
    ...
    if (this._canUsePostMessage) {
        ...
        try {
            var d = c ? this.source : window
              , g = d.opener || {}
              , i = ["parentReceiveHandler", "childReceiveHandler"]
              , b = i[c ? 0 : 1]
              , h = i[c ? 1 : 0];
            g.xpc = g.xpc || {};
            g.xpc[b] = j;
...
baidu.data.storage = (function() {
    ...
    function a() {
        baidu.dom.insertHTML(document.body, "beforeEnd", baidu.string.format('<div id="#{id}" style="display:none;"></div>', {
            id: c + "-storage"
        }));
        ...
        return {
            set: function(o, n, p, r) {
                var k = h.SUCCESS
                  , q = f()
                  , m = i(o)
                  , j = r && r.expires ? r.expires : new Date().getTime() + 365 * 24 * 60 * 60 * 1000;
...
baidu.flash._Base = (function() {
    ...
    return function(r, j) {
        var o = this
          , i = (typeof r.autoRender !== "undefined" ? r.autoRender : true)
          , q = r.createOptions || {}
          , m = null
          , n = false
          , l = []
...
baidu.flash.avatarMaker = function(a) {
    var c = this
      , a = a || {}
      , b = a.uploadURL
      , d = new baidu.flash._Base(a,["uploadCallBack", "tipHandler"]);
    c.upload = function(f) {
        d.call("upload", [f || b])
    }
}
...
baidu.flash.imageUploader = function(a) {
    var b = this
      , a = a || {}
      , c = new baidu.flash._Base(a,["single", "allComplete", "changeHigh"]);
    b.upload = function() {
        c.call("upload")
    }
    ;
...
baidu.form.Validator = baidu.lang.createClass(function(a, g, k) {
    ...
    validate: function(f) {
        var c = this
          , d = baidu.object.keys(c._fieldRule)
          , a = []
          , b = 0;
...
baidu.form.Validator.register(function(a) {
    ...
    a.addEventListener("onvalidatefield", function(b) {
        var f = a._getContentElement(b.field)
          , h = b.resultList.length <= 0
          , d = h ? baidu.object.keys(a._fieldRule[b.field].rule).pop() : b.resultList[0].type
          , c = a._fieldRule[b.field].rule[d]
          , g = c.message;
...
baidu.object.extend(baidu.form.Validator.prototype, {
    ...
    _getContentElement: function(f) {
        var d = this
          , a = d._defaultId + "_" + f
          , c = baidu.dom.g(a)
          , b = baidu.dom.g(d._fieldRule[f].messageContainer);
        if (!c) {
...
baidu.fx.current = function(d) {
    ...
    } while ((d = d.parentNode) && d.nodeType == 1);if (!g) {
        return null
    }
    if ((b = g.match(f)) ) {
        f = /\|([^\|]+)\|/;
...
baidu.i18n.number = baidu.i18n.number || {
    format: function(g, d, j) {
        var a = g;
        var h = this
          , c = d && baidu.i18n.cultures[d].number
          , i = baidu.i18n.cultures[j || baidu.i18n.currentLocale].number
          , b = false;
        if (typeof g === "string") {
    ...
    _format: function(c, j) {
        var a = String(c).split(j.decimal)
          , g = a[0].split("").reverse()
          , b = a[1] || ""
          , f = 0
          , h = 0
